...
class DogWalkEventTypeTest {
    ...
    @Test
    fun `ENERGY category has SQUIRREL_CHASE and LEASH_PULL`() {
    ...
    @Test
    fun `SOCIAL category has FRIENDLY_DOG, BARK_REACT, and HUMAN_FRIEND`() {
        ...
        assertTrue(social.contains(DogWalkEventType.HUMAN_FRIEND))
    }
